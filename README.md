...
INSTALLATION: upload the HTML file with the test questions to your server, together with the file "send_results_to_telegram.php", after editing it with your telegram bot specifications. Then share the link to the HTML file in your server with your students and receive all results in your cell phone.
A preprint describing the tool is available at https://doi.org/10.35542/osf.io/fpe4m_v1.
