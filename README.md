...
INSTALLATION: upload the HTML file with the test questions to your server, together with the file "send_results.php", after editing it with your telegram bot specifications. Then share the link to the HTML file in your server with your students and receive all results in your cell phone.
